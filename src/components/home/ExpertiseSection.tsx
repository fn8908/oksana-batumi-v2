...
import { CheckCircle2, Scale, BarChart3, ArrowRight } from "lucide-react";
...
const EXPERTISE_SERVICES = [
  ...
  },
  {
    key: "rental",
    icon: BarChart3,
    image: "https://images.unsplash.com/photo-1460925895917-adf4e565e371?w=600&q=80"
  },
] as const;
    ...
    <section className="py-20 bg-[#FAF8F5] border-t border-gray-100">
      <div className="container-site">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-100">
          {EXPERTISE_SERVICES.map(({ key, icon: Icon, image }) => (
            <Link
              key={key}
              href={`/${locale}/contact`}
