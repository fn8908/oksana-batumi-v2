    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-site pt-20">
        <div className="max-w-2xl">
          ...
          {/* Subtitle */}
          <p className="font-sans text-base sm:text-lg text-white/75 leading-relaxed mb-10 max-w-lg">
            {t("subtitle")}
          </p>

          {/* CTAs */}
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href={`/${locale}/properties`} className="btn-primary text-sm">
              {t("cta_primary")}
              <ArrowRight size={16} />
            </Link>
            <a
              ...
              className="inline-flex items-center gap-2 border border-white/50 text-white font-sans font-semibold text-sm px-6 py-3 uppercase tracking-wider hover:bg-white/10 transition-colors"
            >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50">
        <span className="font-sans text-xs tracking-widest uppercase">{t("scroll_hint")}</span>
